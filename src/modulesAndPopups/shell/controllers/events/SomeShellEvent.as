package modulesAndPopups.shell.controllers.events
{
    import flash.events.Event;

    import modulesAndPopups.commons.models.vos.ModuleLoaderVO;

    public class SomeShellEvent extends Event
    {
        ...
        public function SomeShellEvent(type:String, moduleLoaderVO:ModuleLoaderVO = null, bubbles:Boolean = false, cancelable:Boolean = false)
        {
        ...
        {
            return new SomeShellEvent(type, moduleLoaderVO, bubbles, cancelable);
        }
    }
}
